...
# Title: Top Block
# Generated: Tue Mar 26 15:04:26 2013
##################################################
...
class top_block(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.notebook_0.AddPage(grc_wxgui.Panel(self.notebook_0), "finalSum")
		...
		self.notebook_0.GetPage(1).Add(self.wxgui_scopesink2_0_1.win)
		...
		self.gr_null_source_1_1_0 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_source_1_1 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_source_1_0_0_0 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_source_1_0_0 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_source_1_0 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_source_1 = gr.null_source(gr.sizeof_gr_complex*1)
		self.gr_null_sink_0_1_0 = gr.null_sink(gr.sizeof_gr_complex*1)
		self.gr_null_sink_0_1 = gr.null_sink(gr.sizeof_gr_complex*1)
		self.gr_null_sink_0_0_0_0 = gr.null_sink(gr.sizeof_gr_complex*1)
		...
		self.eecs_x_corr_0_0_0 = eecs.x_corr(fc, samp_rate, 128)
		self.eecs_x_corr_0_0 = eecs.x_corr(fc, samp_rate, 128)
		...
		self.connect((self.gr_null_source_1, 0), (self.eecs_x_corr_0, 2))
		self.connect((self.gr_null_source_1_0, 0), (self.eecs_x_corr_0, 3))
		self.connect((self.eecs_x_corr_0, 3), (self.gr_null_sink_0_0, 0))
		self.connect((self.eecs_x_corr_0, 2), (self.gr_null_sink_0, 0))
		...
		self.connect((self.gr_null_source_1_1, 0), (self.eecs_x_corr_0_0, 2))
		self.connect((self.eecs_x_corr_0_0, 3), (self.gr_null_sink_0_0_0, 0))
		self.connect((self.eecs_x_corr_0_0, 2), (self.gr_null_sink_0_1, 0))
		self.connect((self.eecs_x_corr_0_0, 1), (self.gr_complex_to_real_0_2_0, 0))
		self.connect((self.eecs_x_corr_0_0, 0), (self.gr_complex_to_real_0_0, 0))
		self.connect((self.eecs_phase_shifter_0, 2), (self.eecs_x_corr_0_0, 0))
		self.connect((self.eecs_phase_shifter_0, 3), (self.eecs_x_corr_0_0, 1))
		self.connect((self.gr_complex_to_real_0_0, 0), (self.wxgui_scopesink2_0_0, 0))
		self.connect((self.gr_complex_to_real_0_2_0, 0), (self.wxgui_scopesink2_0_0, 1))
		...
		self.connect((self.eecs_x_corr_0, 0), (self.blocks_add_xx_0, 0))
		self.connect((self.eecs_x_corr_0, 1), (self.blocks_add_xx_0, 1))
		self.connect((self.eecs_x_corr_0_0, 0), (self.blocks_add_xx_0_0, 0))
		self.connect((self.eecs_x_corr_0_0, 1), (self.blocks_add_xx_0_0, 1))
		self.connect((self.gr_null_source_1_0_0, 0), (self.eecs_x_corr_0_0, 3))
		self.connect((self.gr_null_source_1_1_0, 0), (self.eecs_x_corr_0_0_0, 2))
		self.connect((self.eecs_x_corr_0_0_0, 3), (self.gr_null_sink_0_0_0_0, 0))
		self.connect((self.eecs_x_corr_0_0_0, 2), (self.gr_null_sink_0_1_0, 0))
		self.connect((self.gr_complex_to_real_0_0_1, 0), (self.wxgui_scopesink2_0_0_0, 0))
		self.connect((self.gr_null_source_1_0_0_0, 0), (self.eecs_x_corr_0_0_0, 3))
		self.connect((self.blocks_add_xx_0_0, 0), (self.eecs_x_corr_0_0_0, 1))
		self.connect((self.blocks_add_xx_0, 0), (self.eecs_x_corr_0_0_0, 0))
		self.connect((self.eecs_x_corr_0_0_0, 1), (self.blocks_add_xx_0_0_0, 1))
		self.connect((self.eecs_x_corr_0_0_0, 0), (self.blocks_add_xx_0_0_0, 0))
		self.connect((self.blocks_add_xx_0_0_0, 0), (self.gr_complex_to_real_0_0_1, 0))
	...
	def set_fc(self, fc):
		...
		self.eecs_x_corr_0_0_0.set_freq(self.fc)
	...
	def set_samp_rate(self, samp_rate):
		...
		self.eecs_x_corr_0_0_0.set_sampRate(self.samp_rate)
