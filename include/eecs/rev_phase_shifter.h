#ifndef INCLUDED_EECS_REV_PHASE_SHIFTER_H
#define INCLUDED_EECS_REV_PHASE_SHIFTER_H
...
namespace gr {
	namespace eecs {
		...
		class EECS_API rev_phase_shifter : virtual public gr_sync_block
		{
			public:

			typedef boost::shared_ptr<rev_phase_shifter> sptr;
